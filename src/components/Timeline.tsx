                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute -left-[15px] w-10 rounded-full bg-white dark:bg-midnight flex items-center justify-center">
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            <div className="block mb-4 text-wxl font-bold text-left text-neutral-300 md:hidden">
                                <h3>{item.job}</h3>
                                <h3>{item.date}</h3>
                            </div>
                            {item.contents.map((context, index) => (
                                <p key={index} className="mb-3 font-normal text-neutral-300">
                                    {context}
                                </p>
                            ))}
                        </div>
